...
class MainViewController: NSViewController {
    ...
    override func viewDidLoad() {
		...
		// Setup the bindings
        clockSizeSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "clockFaceHeight",
            options: nil)
        borderSizeSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "borderWidth",
            options: nil)

        majorTickWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "majorTickWidth",
            options: nil)
        majorTickHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "majorTickHeight",
            options: nil)
        majorTickRadiusSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "majorTickRadius",
            options: nil)

        minorTickWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minorTickWidth",
            options: nil)
        minorTickHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minorTickHeight",
            options: nil)
        minorTickRadiusSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minorTickRadius",
            options: nil)

        secondHandWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "secondHandWidth",
            options: nil)
        secondHandHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "secondHandHeight",
            options: nil)
        secondHandOverhangWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "secondHandOverhangWidth",
            options: nil)
        secondHandOverhangHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "secondHandOverhangHeight",
            options: nil)

        minuteHandWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minuteHandWidth",
            options: nil)
        minuteHandHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minuteHandHeight",
            options: nil)
        minuteHandOverhangWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minuteHandOverhangWidth",
            options: nil)
        minuteHandOverhangHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "minuteHandOverhangHeight",
            options: nil)

        hourHandWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "hourHandWidth",
            options: nil)
        hourHandHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "hourHandHeight",
            options: nil)
        hourHandOverhangWidthSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "hourHandOverhangWidth",
            options: nil)
        hourHandOverhangHeightSlider.bind(NSBindingName(rawValue: "value"),
            to: liveSkin.scaling as AnyObject,
            withKeyPath: "hourHandOverhangHeight",
            options: nil)

        lineCapButton.bind(NSBindingName(rawValue: "selectedIndex"),
